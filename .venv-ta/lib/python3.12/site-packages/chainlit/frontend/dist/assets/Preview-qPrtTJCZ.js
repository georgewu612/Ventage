import { n as y, r as v } from "./index-CRSpZLJs.js";
function w(r, e) {
...
var P = Object.create,
  ...
  E = (r, e, t) =>
    e in r
      ...
      : (r[e] = t),
  S = (r, e) => {
    for (var t in e) s(r, t, { get: e[t], enumerable: !0 });
  },
  _ = (r, e, t, n) => {
  ...
  N = (r) => _(s({}, "__esModule", { value: !0 }), r),
  p = (r, e, t) => (E(r, typeof e != "symbol" ? e + "" : e, t), t),
  g = {};
S(g, { default: () => k });
var m = N(g),
  i = C(v);
  ...
  fetchImage({ url: e, light: t, oEmbedUrl: n }) {
    if (!i.default.isValidElement(t)) {
      ...
      return (
        ...
        window
          .fetch(n.replace("{url}", e))
          .then((a) => a.json())
          .then((a) => {
            if (a.thumbnail_url && this.mounted) {
              const o = a.thumbnail_url
...
const D = y(m),
  A = w({ __proto__: null, default: D }, [m]);
export { A as P };
//# sourceMappingURL=Preview-qPrtTJCZ.js.map
