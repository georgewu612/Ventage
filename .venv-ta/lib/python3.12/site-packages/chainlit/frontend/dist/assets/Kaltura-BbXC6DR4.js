import { n as y, r as f, o as _, q as m } from "./index-CRSpZLJs.js";
function P(r, e) {
...
var g = Object.create,
  ...
  D = (r) => c(n({}, "__esModule", { value: !0 }), r),
  s = (r, e, t) => (j(r, typeof e != "symbol" ? e + "" : e, t), t),
  d = {};
L(d, { default: () => i });
var h = D(d),
  u = K(f),
  p = _,
  M = m;
const S = "https://cdn.embed.ly/player-0.1.0.min.js",
  T = "playerjs";
class i extends u.Component {
  constructor() {
    (super(...arguments),
      s(this, "callPlayer", p.callPlayer),
  ...
  load(e) {
    (0, p.getSDK)(S, T).then((t) => {
      this.iframe &&
        ((this.player = new t.Player(this.iframe)),
  ...
  addListeners(e, t) {
    (e.on("play", t.onPlay),
      ...
      e.on("timeupdate", ({ duration: o, seconds: a }) => {
...
const E = y(h),
  N = P({ __proto__: null, default: E }, [h]);
export { N as K };
//# sourceMappingURL=Kaltura-BbXC6DR4.js.map
