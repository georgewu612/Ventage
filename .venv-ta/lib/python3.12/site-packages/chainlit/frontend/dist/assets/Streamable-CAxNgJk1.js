import { n as m, r as f, o as _, q as b } from "./index-CRSpZLJs.js";
function P(t, e) {
...
var g = Object.create,
  ...
  o = (t, e, r) => (L(t, typeof e != "symbol" ? e + "" : e, r), r),
  h = {};
w(h, { default: () => i });
var y = D(h),
  p = M(f),
  u = _,
  d = b;
const E = "https://cdn.embed.ly/player-0.1.0.min.js",
  T = "playerjs";
class i extends p.Component {
  constructor() {
    (super(...arguments),
      o(this, "callPlayer", u.callPlayer),
      o(this, "duration", null),
      o(this, "currentTime", null),
      o(this, "secondsLoaded", null),
      o(this, "mute", () => {
  ...
  load(e) {
    (0, u.getSDK)(E, T).then((r) => {
      this.iframe &&
        ...
        this.player.on("timeupdate", ({ duration: s, seconds: a }) => {
  ...
  render() {
    const e = this.props.url.match(d.MATCH_URL_STREAMABLE)[1],
...
const x = m(y),
  C = P({ __proto__: null, default: x }, [y]);
export { C as S };
//# sourceMappingURL=Streamable-CAxNgJk1.js.map
