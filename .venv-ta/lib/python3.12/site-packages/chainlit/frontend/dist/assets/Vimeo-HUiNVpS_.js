import { n as d, r as f, o as m, q as _ } from "./index-CRSpZLJs.js";
function P(t, e) {
...
var g = Object.create,
  ...
  E = (t) => h(n({}, "__esModule", { value: !0 }), t),
  i = (t, e, r) => (w(t, typeof e != "symbol" ? e + "" : e, r), r),
  c = {};
M(c, { default: () => l });
var y = E(c),
  p = j(f),
  u = m,
  L = _;
const S = "https://player.vimeo.com/api/player.js",
  V = "Vimeo",
  k = (t) => t.replace("/manage/videos", "");
class l extends p.Component {
  constructor() {
    (super(...arguments),
      i(this, "callPlayer", u.callPlayer),
      i(this, "duration", null),
      i(this, "currentTime", null),
      i(this, "secondsLoaded", null),
      i(this, "mute", () => {
        this.setMuted(!0);
      }),
      i(this, "unmute", () => {
    ...
    ((this.duration = null),
      (0, u.getSDK)(S, V).then((r) => {
        ...
        ((this.player = new r.Player(this.container, {
          ...
          this.player.on("seeked", (s) => this.props.onSeek(s.seconds)),
          this.player.on("ended", this.props.onEnded),
          this.player.on("error", this.props.onError),
          this.player.on("timeupdate", ({ seconds: s }) => {
            this.currentTime = s;
          }),
          ...
          this.player.on("playbackratechange", (s) =>
            this.props.onPlaybackRateChange(s.playbackRate),
          ));
      }, this.props.onError));
  }
  refreshDuration() {
  ...
  render() {
    const { display: e } = this.props,
      r = { width: "100%", height: "100%", overflow: "hidden", display: e };
...
i(l, "canPlay", L.canPlay.vimeo);
i(l, "forceLoad", !0);
const T = d(y),
  C = P({ __proto__: null, default: T }, [y]);
export { C as V };
//# sourceMappingURL=Vimeo-HUiNVpS_.js.map
