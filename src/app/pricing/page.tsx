...
const FEATURES: Feature[] = [
  ...
  { label: "历史类比分析", free: false, pro: true, premium: true },
  { label: "监控触发点", free: false, pro: true, premium: true },
  { label: "AI 策略匹配", free: false, pro: true, premium: true },
  { label: "盘前 / 收盘 / 周报", free: false, pro: true, premium: true },
  ...
  {
    label: "参数优化 + Walk-forward 稳健性评估",
    free: false,
    pro: false,
    premium: true,
  },
  { label: "AI 策略 Copilot", free: false, pro: false, premium: true },
  { label: "AI 组合构建器", free: false, pro: false, premium: true },
