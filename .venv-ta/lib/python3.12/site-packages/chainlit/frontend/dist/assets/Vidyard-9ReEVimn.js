import { n as g, r as v, o as b, q as O } from "./index-CRSpZLJs.js";
function V(t, e) {
...
var D = Object.create,
  ...
  R = (t) => h(i({}, "__esModule", { value: !0 }), t),
  s = (t, e, r) => (A(t, typeof e != "symbol" ? e + "" : e, r), r),
  _ = {};
E(_, { default: () => y });
var f = R(_),
  c = L(v),
  d = b,
  P = O;
const x = "https://play.vidyard.com/embed/v4.js",
  C = "VidyardV4",
  N = "onVidyardAPI";
class y extends c.Component {
  constructor() {
    (super(...arguments),
      s(this, "callPlayer", d.callPlayer),
      s(this, "mute", () => {
        this.setVolume(0);
      }),
      s(this, "unmute", () => {
  ...
  load(e) {
    const { playing: r, config: o, onError: a, onDuration: n } = this.props,
      l = e && e.match(P.MATCH_URL_VIDYARD)[1];
    (this.player && this.stop(),
      (0, d.getSDK)(x, C, N).then((p) => {
        this.container &&
          (p.api.addReadyListener((u, m) => {
            this.player ||
              ((this.player = m),
...
const T = g(f),
  K = V({ __proto__: null, default: T }, [f]);
export { K as V };
//# sourceMappingURL=Vidyard-9ReEVimn.js.map
