import { n as m, r as g, o as v, q as w } from "./index-CRSpZLJs.js";
function O(t, e) {
...
var C = Object.create,
  ...
  M = (t) => h(i({}, "__esModule", { value: !0 }), t),
  n = (t, e, a) => (R(t, typeof e != "symbol" ? e + "" : e, a), a),
  d = {};
j(d, { default: () => l });
var _ = M(d),
  y = I(g),
  c = v,
  P = w;
const W = "https://fast.wistia.com/assets/external/E-v1.js",
  x = "Wistia",
  A = "wistia-player-";
class l extends y.Component {
  constructor() {
    (super(...arguments),
      ...
      n(
        this,
        "playerID",
        this.props.config.playerId || `${A}${(0, c.randomString)()}`,
      ),
      n(this, "onPlay", (...e) => this.props.onPlay(...e)),
      n(this, "onPause", (...e) => this.props.onPause(...e)),
      n(this, "onSeek", (...e) => this.props.onSeek(...e)),
  ...
  load(e) {
    ...
    (0, c.getSDK)(W, x).then((f) => {
      (p.customControls && p.customControls.forEach((u) => f.defineControl(u)),
  ...
  render() {
    const { url: e } = this.props,
      a = e && e.match(P.MATCH_URL_WISTIA)[1],
...
n(l, "loopOnEnded", !0);
const L = m(_),
  q = O({ __proto__: null, default: L }, [_]);
export { q as W };
//# sourceMappingURL=Wistia-o0Jpxtph.js.map
