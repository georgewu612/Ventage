import { n as b, r as _, o as O, q as A } from "./index-CRSpZLJs.js";
function R(s, e) {
...
var I = Object.create,
  ...
  U = (s, e, t) =>
    e in s
      ...
      : (s[e] = t),
  N = (s, e) => {
    for (var t in e) u(s, t, { get: e[t], enumerable: !0 });
  },
  v = (s, e, t, i) => {
  ...
  H = (s) => v(u({}, "__esModule", { value: !0 }), s),
  r = (s, e, t) => (U(s, typeof e != "symbol" ? e + "" : e, t), t),
  m = {};
N(m, { default: () => P });
var g = H(m),
  d = j(_),
  a = O,
  c = A;
const y = typeof navigator < "u",
  F = y && navigator.platform === "MacIntel" && navigator.maxTouchPoints > 1,
  E =
    y &&
    (/iPad|iPhone|iPod/.test(navigator.userAgent) || F) &&
    !window.MSStream,
  V =
    y &&
    /^((?!chrome|android).)*safari/i.test(navigator.userAgent) &&
    !window.MSStream,
  T = "https://cdn.jsdelivr.net/npm/hls.js@VERSION/dist/hls.min.js",
  C = "Hls",
  B = "https://cdnjs.cloudflare.com/ajax/libs/dashjs/VERSION/dash.all.min.js",
  x = "dashjs",
  K = "https://cdn.jsdelivr.net/npm/flv.js@VERSION/dist/flv.min.js",
  G = "flvjs",
  X = /www\.dropbox\.com\/.+/,
  f = /https:\/\/watch\.cloudflarestream\.com\/([a-z0-9]+)/,
  W = "https://videodelivery.net/{id}/manifest/video.m3u8";
class P extends d.Component {
  constructor() {
    (super(...arguments),
      r(this, "onReady", (...e) => this.props.onReady(...e)),
      r(this, "onPlay", (...e) => this.props.onPlay(...e)),
      r(this, "onBuffer", (...e) => this.props.onBuffer(...e)),
      r(this, "onBufferEnd", (...e) => this.props.onBufferEnd(...e)),
      r(this, "onPause", (...e) => this.props.onPause(...e)),
      r(this, "onEnded", (...e) => this.props.onEnded(...e)),
      r(this, "onError", (...e) => this.props.onError(...e)),
      r(this, "onPlayBackRateChange", (e) =>
        this.props.onPlaybackRateChange(e.target.playbackRate),
      ),
      r(this, "onEnablePIP", (...e) => this.props.onEnablePIP(...e)),
      r(this, "onDisablePIP", (e) => {
      ...
      r(this, "renderSourceElement", (e, t) =>
        typeof e == "string"
          ? d.default.createElement("source", { key: t, src: e })
          : d.default.createElement("source", { key: t, ...e }),
      ),
      r(this, "renderTrack", (e, t) =>
        d.default.createElement("track", { key: t, ...e }),
      ),
      r(this, "ref", (e) => {
  ...
  componentDidMount() {
    ...
    (e && (this.player.src = e),
      (E || this.props.config.forceDisableHls) && this.player.load());
  }
  ...
  addListeners(e) {
    ...
    (e.addEventListener("play", this.onPlay),
      ...
      this.shouldUseHLS(t) || e.addEventListener("canplay", this.onReady),
      i &&
  ...
  shouldUseAudio(e) {
    return e.config.forceVideo || e.config.attributes.poster
      ? !1
      : c.AUDIO_EXTENSIONS.test(e.url) || e.config.forceAudio;
  }
  shouldUseHLS(e) {
    return (V && this.props.config.forceSafariHLS) || this.props.config.forceHLS
      ? !0
      : E || this.props.config.forceDisableHls
        ? !1
        : c.HLS_EXTENSIONS.test(e) || f.test(e);
  }
  shouldUseDASH(e) {
  ...
  load(e) {
    ...
    if (
      ...
      this.shouldUseHLS(e) &&
        (0, a.getSDK)(T.replace("VERSION", t), C).then((o) => {
          if (
            ((this.hls = new o(i)),
            this.hls.on(o.Events.MANIFEST_PARSED, () => {
              this.props.onReady();
            }),
      ...
      this.shouldUseDASH(e) &&
        (0, a.getSDK)(B.replace("VERSION", n), x).then((o) => {
          ((this.dash = o.MediaPlayer().create()),
            this.dash.initialize(this.player, e, this.props.playing),
            this.dash.on("error", this.props.onError),
            parseInt(n) < 3
              ? this.dash.getDebug().setLogToBrowserConsole(!1)
              : this.dash.updateSettings({
                  debug: { logLevel: o.Debug.LOG_LEVEL_NONE },
                }),
            this.props.onLoaded());
        }),
      this.shouldUseFLV(e) &&
        (0, a.getSDK)(K.replace("VERSION", l), G).then((o) => {
          ((this.flv = o.createPlayer({ type: "flv", url: e })),
            this.flv.attachMediaElement(this.player),
            this.flv.on(o.Events.ERROR, (h, p) => {
  ...
  render() {
    const {
      ...
      L = this.shouldUseAudio(this.props) ? "audio" : "video",
      S = {
        width: h === "auto" ? h : "100%",
        height: p === "auto" ? p : "100%",
      };
...
const q = b(g),
  J = R({ __proto__: null, default: q }, [g]);
export { J as F };
//# sourceMappingURL=FilePlayer-Cd3F_AGR.js.map
