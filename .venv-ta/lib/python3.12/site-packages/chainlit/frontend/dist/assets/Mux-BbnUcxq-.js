import { n as m, _ as E, r as g, q as _ } from "./index-CRSpZLJs.js";
function b(r, e) {
...
var L = Object.create,
  ...
  w = (r, e, t) => (
    (t = r != null ? L(O(r)) : {}),
    y(
      !r || !r.__esModule ? u(t, "default", { value: r, enumerable: !0 }) : t,
      r,
    )
  ),
  D = (r) => y(u({}, "__esModule", { value: !0 }), r),
  n = (r, e, t) => (M(r, typeof e != "symbol" ? e + "" : e, t), t),
  v = {};
R(v, { default: () => l });
var P = D(v),
  f = w(g),
...
class l extends f.Component {
  constructor() {
    (super(...arguments),
      n(this, "onReady", (...e) => this.props.onReady(...e)),
      n(this, "onPlay", (...e) => this.props.onPlay(...e)),
      n(this, "onBuffer", (...e) => this.props.onBuffer(...e)),
      n(this, "onBufferEnd", (...e) => this.props.onBufferEnd(...e)),
      n(this, "onPause", (...e) => this.props.onPause(...e)),
      n(this, "onEnded", (...e) => this.props.onEnded(...e)),
      n(this, "onError", (...e) => this.props.onError(...e)),
      n(this, "onPlayBackRateChange", (e) =>
        this.props.onPlaybackRateChange(e.target.playbackRate),
      ),
      n(this, "onEnablePIP", (...e) => this.props.onEnablePIP(...e)),
      n(this, "onSeek", (e) => {
  ...
  async load(e) {
    ...
    if (!((t = globalThis.customElements) != null && t.get("mux-player")))
      try {
        ...
        (await E(() => import(`${a}`), []), this.props.onLoaded());
      } catch (a) {
        i(a);
      }
  ...
  render() {
    ...
    return (
      s === !1 && (c["--controls"] = "none"),
      f.default.createElement("mux-player", {
        ref: this.ref,
...
const C = m(P),
  B = b({ __proto__: null, default: C }, [P]);
export { B as M };
//# sourceMappingURL=Mux-BbnUcxq-.js.map
