import { n as _, r as f, o as m, q as g } from "./index-CRSpZLJs.js";
function v(t, e) {
...
var P = Object.create,
  ...
  S = (t) => c(i({}, "__esModule", { value: !0 }), t),
  a = (t, e, r) => (x(t, typeof e != "symbol" ? e + "" : e, r), r),
  d = {};
j(d, { default: () => l });
var h = S(d),
  p = D(f),
  u = m,
  y = g;
const E = "https://widget.mixcloud.com/media/js/widgetApi.js",
  L = "Mixcloud";
class l extends p.Component {
  constructor() {
    (super(...arguments),
      a(this, "callPlayer", u.callPlayer),
      a(this, "duration", null),
      a(this, "currentTime", null),
      a(this, "secondsLoaded", null),
      a(this, "mute", () => {}),
      a(this, "unmute", () => {}),
      a(this, "ref", (e) => {
        this.iframe = e;
      ...
      ((this.player = r.PlayerWidget(this.iframe)),
        this.player.ready.then(() => {
          (this.player.events.play.on(this.props.onPlay),
            ...
            this.player.events.progress.on((s, o) => {
  ...
  render() {
    const { url: e, config: r } = this.props,
      s = e.match(y.MATCH_URL_MIXCLOUD)[1],
      o = { width: "100%", height: "100%" },
      n = (0, u.queryString)({ ...r.options, feed: `/${s}/` });
...
a(l, "loopOnEnded", !0);
const T = _(h),
  N = v({ __proto__: null, default: T }, [h]);
export { N as M };
//# sourceMappingURL=Mixcloud-CrF-HKfZ.js.map
