import { n as U, r as I, o as L, q as M } from "./index-CRSpZLJs.js";
function Y(a, e) {
...
var k = Object.create,
  ...
  x = (a, e, t) =>
    e in a
      ...
      : (a[e] = t),
  K = (a, e) => {
    for (var t in e) u(a, t, { get: e[t], enumerable: !0 });
  },
  v = (a, e, t, s) => {
  ...
  H = (a) => v(u({}, "__esModule", { value: !0 }), a),
  o = (a, e, t) => (x(a, typeof e != "symbol" ? e + "" : e, t), t),
  w = {};
K(w, { default: () => O });
var S = H(w),
  b = F(I),
  c = L,
  D = M;
const G = "https://www.youtube.com/iframe_api",
  T = "YT",
  z = "onYouTubeIframeAPIReady",
  f = /[?&](?:list|channel)=([a-zA-Z0-9_-]+)/,
  m = /user\/([a-zA-Z0-9_-]+)\/?/,
...
class O extends b.Component {
        ...
        const { data: t } = e,
          {
            ...
            onReady: g,
            loop: y,
            config: { playerVars: l, onUnstarted: d },
          } = this.props,
          {
            UNSTARTED: h,
            PLAYING: p,
  ...
  getID(e) {
    return !e || e instanceof Array || f.test(e)
      ? null
      : e.match(D.MATCH_URL_YOUTUBE)[1];
  }
  load(e, t) {
    const {
        playing: s,
        ...
        (this.player = new p.Player(this.container, {
          ...
          events: {
            ...
            onPlaybackRateChange: (i) =>
              this.props.onPlaybackRateChange(i.data),
            onPlaybackQualityChange: (i) =>
              this.props.onPlaybackQualityChange(i),
  ...
  render() {
    ...
    return b.default.createElement(
      "div",
      { style: t },
      b.default.createElement("div", { ref: this.ref }),
    );
  }
}
...
const $ = U(S),
  J = Y({ __proto__: null, default: $ }, [S]);
export { J as Y };
//# sourceMappingURL=YouTube-CIuNm_ik.js.map
